...
| [llm-gateway.md](llm-gateway.md) | LLMClient 인터페이스 · OpenAI-compatible · 구현체 교체 전략 · 운영 로그 정책 |
| [prompt-strategy.md](prompt-strategy.md) | PromptBuilder 분리 이유 · RAG 프롬프트 구조 · 금지 패턴 |
